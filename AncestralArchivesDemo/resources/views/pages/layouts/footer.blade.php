            ...
            <div class="col-md-2">
                <div class="ftco-footer-widget mb-4 ml-md-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="nav-item"><a href="#" class="nav-link">Shops&Trainings</a></li>
                        ...
                        <li class="nav-item"><a href="{{ route('pages.dashboard') }}" class="nav-link">Dashboard</a>
                        </li>
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            ...
                            <li><a href="#"><span class="icon icon-envelope"></span><span
                                        class="text">ancestralarchives@gmail.com</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
